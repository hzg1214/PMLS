    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form">
                ...
                <input type="hidden" name="estateType" id="estateType" value="fyfy">
                    ...
                    <%--<div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="estateType" name="estateType" lay-verify="required" lay-search=""
                               ...
                               &lt;%&ndash; <c:forEach items="${estateTypeList}" var="list">
                                    <option value="${list.dicCode}">${list.dicValue}</option>
                                </c:forEach>&ndash;%&gt;
                                <option value="24503">应计返佣模板</option>
                                <option value="24505">实际返佣模板</option>
                            </select>
                        </div>
                    </div>--%>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/commission/commissionFyFy.js?_v=${vs}"></script>
