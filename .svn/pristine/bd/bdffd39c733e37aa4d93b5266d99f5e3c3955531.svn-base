                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="companyNo" name="companyNo" class="layui-input" autocomplete="off" placeholder="编号、名称">
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['element', 'form', 'table', 'layer'], function () {
        ...
        function setCols() {
            ...
            row1.push(
                {type: 'radio'},
                {field: 'companyNo', title: '编号', width: 200, align: 'center'},
                {field: 'companyName', title: '公司名称', width: 417, align: 'center', style: 'text-align: left'},
                {field: 'cityName', title: '归属城市', width: 120, align: 'center'}
            );
            var cols = [];
            cols.push(row1);
            return cols;
        ...
        function reloadData() {
            ...
            table.reload('mainTable', {
                url: BASE_PATH + '/jsStatement/queryJsCompanyList',
                cols: setCols(),
