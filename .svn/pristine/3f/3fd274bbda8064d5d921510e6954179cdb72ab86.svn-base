...
<div>
    <table class="table table-striped table-hover table-bordered">
        ...
        <tr>
            ...
            <th scope="col">管理人员工号</th>
            <th scope="col">管理人员姓名</th>
            <th scope="col">创建人</th>
        ...
        <c:forEach items="${contentlist}" var="list">
            <tr>
                ...
                <td align="center">
                    <div class="mailopre">
                        <a href="javascript:mCenterUser.modify('${list.id}')">编辑</a>
                        <a href="javascript:mCenterUser.remove('${list.id}','${list.userCode}')">删除</a>
                    </div>
                </td>
            </tr>
        </c:forEach>
