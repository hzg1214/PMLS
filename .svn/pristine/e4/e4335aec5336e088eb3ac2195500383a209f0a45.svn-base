...
import cn.com.eju.deal.poi.ExcelForLnkYjNy;
...
public class LnkYjNyController extends BaseController {
    ...
    public String index(HttpServletRequest request, ModelMap mop) {
        ...
        try {
            ...
            logger.error("estate", "EstateService", "getProjectDepartment", cityNo, null, "", "创建--初始化-归属项目部", e);
        }
        try {
            Map<String, Object> reqMap = new HashMap<>();
            reqMap.put("cityNo", cityNo);
            ...
            logger.error("estate", "EstateService", "getEstateNmList", cityNo, null, "", "创建--初始化-楼盘名称", e);
        }

        return "scene/commission/lnkYjNyList";
    }
    ...
    public String queryList(HttpServletRequest request, ModelMap mop) {
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = lnkYjNyService.getLnkYjNyList(reqMap, pageInfo);
        } catch (Exception e) {
            logger.error("lnkYjNy", "SceneYSSRCommissionController", "queryList", JsonUtil.parseToJson(reqMap), null, "", "", e);
            reback.setFail();
        }
        ...
        returnAddress = "scene/commission/lnkYjNyListCtx";
    ...
    public void export(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ResultData<?> reback = lnkYjNyService.getLnkYjNyList(reqMap, null);
            ...
            logger.error("sceneYSSRCommission",
                    "SceneYSSRCommissionController",
                    "export",
    ...
    public ReturnView<?, ?> exportCheck(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = lnkYjNyService.getLnkYjNyList(reqMap, null);
            List<LinkedHashMap<String, Object>> contentlist = (List<LinkedHashMap<String, Object>>) reback.getReturnData();
    ...
    public ReturnView<?, ?> imput(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("lnkYjNy", "LnkYjNyController", "imput", "", null, "", "", e1);
            rspMap.put(Constant.RETURN_CODE_KEY, ReturnCode.FAILURE);
            rspMap.put(Constant.RETURN_MSG_KEY, "导入数据失败！");
        }
    ...
    private ResultData insertLinkImport(List<Map<String, Object>> mapList) {
        ...
        try {
            resultData = lnkYjNyService.nyImport(mapList);
            return resultData;
        } catch (Exception e) {
