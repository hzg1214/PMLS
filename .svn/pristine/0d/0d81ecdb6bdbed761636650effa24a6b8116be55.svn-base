        ...
        <div class="layui-card-body">
            <div class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label">是否签框架</label>
                        <div class="layui-input-inline">
                            <select id="isFrameContract" name="isFrameContract" lay-filter="isFrameContract">
                            	<option value="">请选择</option>
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label">大定数据</label>
                        <div class="layui-input-inline">
...
<script type="text/javascript"
        src="${ctx}/meta/pmls/js/statisticsReport/rptCompany/rptCompanyDetailList.js?_v=${vs}"></script>
