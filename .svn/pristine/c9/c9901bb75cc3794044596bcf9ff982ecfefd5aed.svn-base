                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="inputLinkUserName" autocomplete="off" name="inputLinkUserName" class="layui-input" placeholder="请输入">
                        </div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/scene/sceneTrade/selFyUser.js?_v=${vs}"></script>
</body>
</html>
