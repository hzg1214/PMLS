...
public class Post implements Serializable
{
    ...
    */
     ...
     * 岗位层级（显示值，临时变量）
     */
    private String postLevelValue;
    
    /**
     * 岗位审批优先级
     */
    private Integer approveIdx;
    ...
    public Integer getApproveIdx()
    {
        return approveIdx;
    }
    
    public void setApproveIdx(Integer approveIdx)
    {
        this.approveIdx = approveIdx;
    }
