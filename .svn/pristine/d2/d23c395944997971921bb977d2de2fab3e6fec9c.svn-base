				...
				<table class="layui-table">
					...
					<tbody>
						<tr>
							...
							<input type="hidden" id="planType" name="planType" value="28101"/>
							<td align="center">固定<input type="text" style="width: 100px;height: 25px;text-align: right;" maxlength="18" oninput="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[''])[0]" id="fixAmount" name="fixAmount" value=""/>元&nbsp;&nbsp;+&nbsp;&nbsp;总价<input type="text" style="width: 100px;height: 25px;text-align: right;" id="totalPercentage" oninput="value=checkPercentage(value)" maxlength="18" name="totalPercentage" value=""/>%</td>
						</tr>
					</tbody>
				</table>
			</div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/estate/estateIncomePlan.js?_v=${vs}"></script>
</body>
</html>
