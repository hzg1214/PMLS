...
import cn.com.eju.pmls.otherReport.service.LnkYjQtFyService;
import cn.com.eju.pmls.poi.ExcelForQtFy;
...
//            mop.put("districtList", resultDistrictList.getReturnData());
            ...
            logger.error("lnkYjQtFy", "LnkYjQtFyController", "", "", null, "", "查询基础信息失败！", e);
        }
        return "otherReport/lnkYjQtFyList";
    }

    @RequestMapping(value = "getLnkYjQtFyList", method = RequestMethod.POST)
    @ResponseBody
    public ResultData<?> list(HttpServletRequest request, ModelMap mop) {
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = lnkYjQtFyService.getLnkYjQtFyList(reqMap, pageInfo);

        } catch (Exception e) {
            logger.error("lnkYjQtFy", "LnkYjQtFyController", "getLnkYjQtFyList", "", null, "", "", e);
            reback.setFail();
        }
...
/*        //页面数据
    ...
    public void export(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                ...
                String templateTypeStr = "应计返佣模板";
                if(templateType.equals("yjfy")){
                    templateTypeStr = "应计返佣模板";
                }else if (templateType.equals("sjfy")){
                    templateTypeStr = "实际返佣模板";
                }

                String pathName = url + File.separator + time + File.separator + templateTypeStr + ".xlsx";
                ExcelForQtFy instance = new ExcelForQtFy(templateType);
    ...
    public ModelAndView toView() {
        ModelAndView mv = new ModelAndView("otherReport/importExcellnkYjQtFyList");
        return mv;
    }
    ...
    public ReturnView<?, ?> imput(HttpServletRequest request, HttpServletResponse response) {
      ...
      /*  MultipartHttpServletRequest multiRequest = (MultipartHttpServletRequest) request;
        ...
        try {
            ...
            logger.error("lnkYjQtFy", "LnkYjQtFyController", "imput", "", null, "", "", e1);
            rspMap.put(Constant.RETURN_CODE_KEY, ReturnCode.FAILURE);
    ...
    private Integer getSheetCellValue(Workbook wb, Row r, List<Map<String, Object>> mapList, String estateType) {
        ...
        //套数
        String num = getCellValue(wb, r.getCell(39));
        //税前
        String befTaxAmountTotal = getCellValue(wb, r.getCell(9));
        //税后
        String aftTaxAmountTotal = getCellValue(wb, r.getCell(10));
        //税前
        String befTaxAmount = getCellValue(wb, r.getCell(11));
        //税后
        String aftTaxAmount = getCellValue(wb, r.getCell(12));
        //日期
        String recordDate = getCellValue(wb, r.getCell(13));
        //税前
        String befTaxAmount1 = getCellValue(wb, r.getCell(14));
        //税后
        String aftTaxAmount1 = getCellValue(wb, r.getCell(15));
        //日期
        String recordDate1 = getCellValue(wb, r.getCell(16));
        //税前
        String befTaxAmount2 = getCellValue(wb, r.getCell(17));
        //税后
        String aftTaxAmount2 = getCellValue(wb, r.getCell(18));
        //日期
        String recordDate2 = getCellValue(wb, r.getCell(19));
        //税前
        String befTaxAmount3 = getCellValue(wb, r.getCell(20));
        //税后
        String aftTaxAmount3 = getCellValue(wb, r.getCell(21));
        //日期
        String recordDate3 = getCellValue(wb, r.getCell(22));
        //税前
        String befTaxAmount4 = getCellValue(wb, r.getCell(23));
        //税后
        String aftTaxAmount4 = getCellValue(wb, r.getCell(24));
        //日期
        String recordDate4 = getCellValue(wb, r.getCell(25));
        //税前
        String befTaxAmount5 = getCellValue(wb, r.getCell(26));
        //税后
        String aftTaxAmount5 = getCellValue(wb, r.getCell(27));
        //日期
        String recordDate5 = getCellValue(wb, r.getCell(28));
        //税前
        String befTaxAmount6 = getCellValue(wb, r.getCell(29));
        //税后
        String aftTaxAmount6 = getCellValue(wb, r.getCell(30));
        //日期
        String recordDate6 = getCellValue(wb, r.getCell(31));
        //公司编号
        String companyNo = getCellValue(wb, r.getCell(4));

        String switchFlag = getCellValue(wb, r.getCell(32));
        String switchFlag1 = getCellValue(wb, r.getCell(33));
        String switchFlag2 = getCellValue(wb, r.getCell(34));
        String switchFlag3 = getCellValue(wb, r.getCell(35));
        String switchFlag4 = getCellValue(wb, r.getCell(36));
        String switchFlag5 = getCellValue(wb, r.getCell(37));
        String switchFlag6 = getCellValue(wb, r.getCell(38));
        String reportId = getCellValue(wb, r.getCell(40));
        ...
        try{
            ...
            logger.error("getSheetCellValue", "LnkYjQtFyController", "imput", "", null, "", "日期转换失败", e);
        }
        //只要填了值就添加数据库
    ...
    private ResultData insertLinkImport(List<Map<String, Object>> mapList) {
        ...
        try {
            List<LnkYjFyDto> yjFyDtoList = new ArrayList<LnkYjFyDto>();
            ...
            for (Map<String, Object> map : mapList) {
                ...
                LnkYjFyDto yjFyDto = new LnkYjFyDto();
                yjFyDto.setCityNo(cityNo);
                yjFyDto.setReportNo(reportNo);
                yjFyDto.setReportId(reportId);
                yjFyDto.setCompanyNo(companyNo);
                yjFyDto.setCrtEmpId(CrtEmpId);
                yjFyDto.setUptEmpId(UptEmpId);
                yjFyDto.setDelFlag(delFlg);

                yjFyDto.setBefTaxAmountTotal(befTaxAmountTotal);
                yjFyDto.setAftTaxAmountTotal(aftTaxAmountTotal);
                yjFyDto.setBefTaxAmount(befTaxAmount);
                yjFyDto.setAftTaxAmount(aftTaxAmount);
                yjFyDto.setRecordDate(recordDate);
                yjFyDto.setBefTaxAmount1(befTaxAmount1);
                yjFyDto.setAftTaxAmount1(aftTaxAmount1);
                yjFyDto.setRecordDate1(recordDate1);
                yjFyDto.setBefTaxAmount2(befTaxAmount2);
                yjFyDto.setAftTaxAmount2(aftTaxAmount2);
                yjFyDto.setRecordDate2(recordDate2);
                yjFyDto.setBefTaxAmount3(befTaxAmount3);
                yjFyDto.setAftTaxAmount3(aftTaxAmount3);
                yjFyDto.setRecordDate3(recordDate3);
                yjFyDto.setBefTaxAmount4(befTaxAmount4);
                yjFyDto.setAftTaxAmount4(aftTaxAmount4);
                yjFyDto.setRecordDate4(recordDate4);
                yjFyDto.setBefTaxAmount5(befTaxAmount5);
                yjFyDto.setAftTaxAmount5(aftTaxAmount5);
                yjFyDto.setRecordDate5(recordDate5);
                yjFyDto.setBefTaxAmount6(befTaxAmount6);
                yjFyDto.setAftTaxAmount6(aftTaxAmount6);
                yjFyDto.setRecordDate6(recordDate6);
                yjFyDto.setNum(Integer.valueOf(num));
                yjFyDto.setSwitchFlag(Integer.valueOf(switchFlag));
                yjFyDto.setSwitchFlag1(Integer.valueOf(switchFlag1));
                yjFyDto.setSwitchFlag2(Integer.valueOf(switchFlag2));
                yjFyDto.setSwitchFlag3(Integer.valueOf(switchFlag3));
                yjFyDto.setSwitchFlag4(Integer.valueOf(switchFlag4));
                yjFyDto.setSwitchFlag5(Integer.valueOf(switchFlag5));
                yjFyDto.setSwitchFlag6(Integer.valueOf(switchFlag6));
                yjFyDto.setEstateType(estateType);

                yjFyDtoList.add(yjFyDto);

            }

            resultData = lnkYjQtFyService.insertLnkQtFy(yjFyDtoList);
            return resultData;
        } catch (Exception e) {
