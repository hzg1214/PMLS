            ...
            <div class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" autocomplete="off" id="project" maxlength="200"
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="debtsType" name="debtsType" xm-select="debtsType" xm-select-skin="normal"
                                    xm-select-height="30px" xm-select-search="" xm-select-show-count='1'>
                                <option value="">请选择</option>
                                <option value="zx">自行计提</option>
                                <option value="cf">惩罚性计提</option>
                                <option value="df">抵房计提</option>
                                <option value="ss">诉讼计提</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">收入节点</label>
                        <div class="layui-input-inline">
                            <select id="revenueNode" name="revenueNode" xm-select="revenueNode" xm-select-skin="normal"
                                    xm-select-height="30px" xm-select-search="" xm-select-show-count='1'>
                                <option value="">请选择</option>
                                <option value="yj">应计</option>
                                <option value="ys">应收</option>
                                <option value="kp">开票</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript"
        src="${ctx}/meta/pmls/js/statisticsReport/badDebts/badDebtsDetailList.js?_v=${vs}"></script>
