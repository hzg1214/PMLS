                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="estateType" name="estateType" lay-verify="required" lay-search=""
                                ...
                                <option value="yjfy">应计返佣模板</option>
                                <option value="sjfy">实际返佣模板</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/otherReport/lnkYjQtFyList.js?_v=${vs}"></script>
