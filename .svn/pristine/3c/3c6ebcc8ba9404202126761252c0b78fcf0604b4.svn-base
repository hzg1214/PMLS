layui.use(['element', 'laydate', 'table', 'form', 'layer'], function () {
    ...
    active = {
        ...
        export: function () {
            if (valid()) {
                ...
                var url = LOC_RES_BASE_PATH + '/pmlsLinkProjectPartATrace/exportLinkProjectPartATraceAjax?'
    ...
    function reloadData(optionsData) {
        ...
        table.reload('contentReload', {
            url: BASE_PATH + '/pmlsLinkProjectPartATrace/queryLinkProjectPartATraceList',
            cols: setCols(),
    ...
    function setCols() {
        ...
        row1.push(
            ...
            , {field: 'partnerAbbreviationNm', title: '甲方简称', width: 150, align: 'center', colspan: 1, rowspan: 3}
            ...
            , {field: '', title: '总累计', width: 150, align: 'center', colspan: 24, rowspan: 1}
        ...
        row2.push(
            ...
            , {field: 'totalYjBadDebt', title: '应计坏账(自行计提)', width: 150, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYjBadDfDebt', title: '应计坏账(抵房坏账)', width: 150, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYjBadssDebt', title: '应计坏账(诉讼计提)', width: 150, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYjBadPunishDebt', title: '应计坏账(惩罚性计提)', width: 150, align: 'center', colspan: 1, rowspan: 2}

            , {field: 'totalYsBadDebt', title: '应收坏账(自行计提)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYsBadDfDebt', title: '应收坏账(抵房坏账)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYsBadssDebt', title: '应收坏账(诉讼计提)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalYsBadPunishDebt', title: '应收坏账(惩罚)', width: 180, align: 'center', colspan: 1, rowspan: 2}

            , {field: 'totalKpBadDebt', title: '开票坏账(自行计提)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalKpBadDfDebt', title: '开票坏账(抵房坏账)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalKpBadssDebt', title: '开票坏账(诉讼计提)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            , {field: 'totalKpBadPunishDebt', title: '开票坏账(惩罚)', width: 180, align: 'center', colspan: 1, rowspan: 2}
            ...
            , {field: 'dyyjwh1399', title: '一年以上', width: 150, align: 'center', colspan: 1, rowspan: 2}
    ...
    function fileInterval() {
        var url = BASE_PATH + '/expendReport/fileIntervalByName/' + "linkProjectPartATrace_filepath";
    ...
    function downLoadExcel2(fileId) {
        ...
        var url = BASE_PATH + '/expendReport/queryReportSize/' + "linkProjectPartATrace_filepath";
        $.ajax({
            type: "GET",
            url: url,
            async: true,
