...
<head>
    ...
    <script type="text/javascript" src="${ctx}/meta/js/performanceSum/performanceSumYear.js?_v=${vs}"></script>
    ...
    <div class="row">
        ...
        <div class="page-content">
            ...
            <form id="PerformanceSumForm">
                ...
                <input type="hidden" name="type" id="type" value="yearly">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <button type="button" class="btn btn-primary" id="J_search"
                                    onclick="javascript:PerformanceSumYear.search();">查询
                            </button>
                            <button type="button" class="btn btn-primary" id="btn-reset"
                                    onclick="javascript:PerformanceSumYear.export()">导出
                            </button>
                        </div>
                    </div>
                </div>
