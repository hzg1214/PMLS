...
<div class="" role="main">
    ...
    <span class="" style="float:right">
        <a href="javascript:LinkAchieveChange2.close();" class="btn btn-default">&times;</a>
    </span>
    ...
    <div class="row">
        <div class="page-content" style="clear: initial;">
            ...
            <form id="achieveMentUserForm">
                ...
                <input type="hidden" id="adjutFlag2" name="adjutFlag2" value="${adjutFlag2}">
                ...
                <ul class="list-inline form-inline" style="margin-bottom: 0px;">
                    <li>
                        ...
                        <button type="button" class="btn btn-primary" onclick="javascript:AchieveMentUser2.search();">
                            搜索
                        </button>
                    </li>
                </ul>
