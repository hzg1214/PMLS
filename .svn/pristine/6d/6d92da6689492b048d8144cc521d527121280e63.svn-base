...
<script type="text/javascript" src="${ctx}/meta/js/store/storeAuthCheck.js?_v=${vs}"></script>
						...
						<div class="panel panel-default">
							<div class="panel-body">
                                ...
                                <div class="form-inline">
                                    <div>
										<div class="form-group">
											<label>维护人</label> <input type="text" style="width:160px"  class="form-control" 
																		id="userCode" name="userCode" placeholder="工号、姓名">
										</div>
                                        <div class="form-group">
                                            <label>创建时间</label>
										...
										<div class="form-group">
											<label>审核状态</label>
											<t:dictSelect field="approveStatus" id="approveStatus" xmlkey="LOOKUP_Dic" dbparam="P1:233" nullOption="请选择" classvalue="30" txWidth="160px;"></t:dictSelect>
										</div>

                                        <div class="pull-right">
                                            <button type="button" class="btn btn-primary" id="J_search"
                                                onclick="javascript:StoreAuthCheck.search();">搜索</button>
                                            <button type="button" class="btn btn-default" onclick="javascript:StoreAuthCheck.reset('${list_search_page}');">重置</button>
                                        </div>
                                    </div>
                                </div>
							</div>
