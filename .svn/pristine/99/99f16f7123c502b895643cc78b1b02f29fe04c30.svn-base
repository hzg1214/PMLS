...
import cn.com.eju.deal.dto.common.CityFirstLetterDto;
import cn.com.eju.deal.dto.common.PmlsUserCenterCitySettingDto;
import cn.com.eju.deal.dto.user.Auth;
import cn.com.eju.deal.dto.user.ExchangeCenter;
...
public class UserInfo extends BaseModel implements Serializable
{
    ...
    private List<PmlsUserCenterCitySettingDto> centeres;

    private List<CityFirstLetterDto> flCities;

    public List<CityFirstLetterDto> getFlCities() {
        return flCities;
    }

    public void setFlCities(List<CityFirstLetterDto> flCities) {
        this.flCities = flCities;
    }

    public List<PmlsUserCenterCitySettingDto> getCenteres() {
		return centeres;
	}

	public void setCenteres(List<PmlsUserCenterCitySettingDto> centeres) {
    ...
    public String toString()
    {
        return "UserInfo [userId=" + userId + ", userCode=" + userCode + ", password=" + password + ", userName="
            + userName + ", sex=" + sex + ", sexName=" + sexName + ", groupName=" + groupName + "]";
    }
