...
public class HttpPostEmulator
{
    ...
    public String sendHttpPostRequest(String serverUrl, ArrayList<FormFieldKeyValuePair> generalFormFields,
        ArrayList<UploadFileItem> filesToBeUploaded, ArrayList<FormFieldKeyValuePair> generalHeaderFields)
        throws Exception
    {
        ...
        if (generalHeaderFields != null && generalHeaderFields.size() > 0)
        {
            for (FormFieldKeyValuePair keyValue : generalHeaderFields)
            {
     ...
     * @return
     */
    public static String setHeaderStr(List<FormFieldKeyValuePair> headers)
    {
        StringBuffer headerStr = new StringBuffer();
        for (int i = 0; i < headers.size(); i++)
        {
            FormFieldKeyValuePair header = headers.get(i);
