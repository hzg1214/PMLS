...
<%--                            <input type="hidden" id="estateNmKey" name="estateNmKey" />--%>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="projectNo" id="projectNo" lay-verify="projectNo"  placeholder="请输入"   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="reportNo" id="reportNo" lay-verify="reportNo" placeholder="请输入"  autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline w90">
                            <input type="text" name="countDateEnd" id="countDateEnd" lay-verify="countDateEnd"
                                   ...
                                   autocomplete="off" class="layui-input" placeholder="结束日期">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="estateType" name="estateType" lay-verify="required" lay-search=""
                                ...
                                <option value="yjsr">应计收入模板</option>
                                <option value="yssr">应收收入模板</option>
                                <option value="yjss">应计实收模板</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/otherReport/lnkYjQtWyList.js?_v=${vs}"></script>
