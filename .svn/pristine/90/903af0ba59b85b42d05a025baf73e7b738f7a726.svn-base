...
<script type="text/javascript" src="${ctx}/meta/js/houseLinkage/report/reportToValided.js?_v=${vs}"></script>
        ...
        <div class="row">
            ...
            <div class="page-content">
                <form  id="ReportToValidedForm">
					...
					<input type="hidden" id="roughAuditStatus" name="roughAuditStatus" value="'1','2'"/>
                    ...
                    <div class="panel-body">
                    	<div class="form-inline">
							...
							<div class="form-group">
								<select class="form-control" style="width:175px;" id="roughAuditStatusSelect" name="roughAuditStatusSelect">
									<option value="">请选择大定审核结果</option>
									<option value="1">审核通过</option>
									<option value="2">审核驳回</option>
								</select>
							</div>
		                  <div class="form-group">
		                  		<input type="text" style="width: 400px;" class="form-control " id="estateNm" name="estateNm"  placeholder="请输入报备编号/楼盘名/经纪公司/客户名称/客户手机号" size="58">
		                  </div>
		                </div>
		                ...
		                <div class="form-inline">
		                  ...
		                  <div class="form-group">
							...
							<button type="button" class="btn btn-primary" id="J_search" onclick="javascript:ReportToValided.search();">查询</button>
							<button type="button" id="btn-reset" class="btn btn-default" onclick="javascript:ReportToValided.reset()">重置</button>
		                </div>
                    </div>
                </div>
                    <!-- 异步加载列表内容 -->
...
<script type="text/javascript">
	...
	if (searchParamMap != undefined && searchParamMap != null && searchParamMap != '') {
        ReportToValided.setSearchParams(searchParamMap);
	}
</script>
