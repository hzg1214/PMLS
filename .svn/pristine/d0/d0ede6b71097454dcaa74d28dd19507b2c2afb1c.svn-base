...
import cn.com.eju.pmls.poi.ExcelForCommision;
...
import cn.com.eju.pmls.commission.service.PmlsSceneCommissionService;
...
*/
@Controller
@RequestMapping(value = "pmlsSceneCommission")
class PmlsSceneCommissionController extends BaseController
{
    /**
     * 日志
     */
    ...
    @Resource(name = "pmlsSceneCommissionService")
    private PmlsSceneCommissionService pmlsSceneCommissionService;
...
//            mop.put("districtList", resultDistrictList.getReturnData());
            ...
            logger.error("pmlsSceneCommission", "PmlsSceneCommissionController", "", "", null, "", "", e);
        }
     ...
     * @return
     */
    @RequestMapping(value = "yjSjFyList", method = RequestMethod.GET)
...
/*            ResultData<?> resultDistrictList = this.linkageCityService.getDistrictList(cityNo);
        ...
        return "commission/commissionListFy";
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "qSceneLinkCommission", method = RequestMethod.POST)
    public ResultData<?> qSceneLinkCommission(HttpServletRequest request, ModelMap mop) {
        String cityNo = UserInfoHolder.get().getCityNo();
        //获取请求参数
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = pmlsSceneCommissionService.getLinkCommissionList(reqMap, pageInfo);

        } catch (Exception e) {
            logger.error("pmlsSceneCommission", "PmlsSceneCommissionController", "qSceneLinkCommission", "", null, "", "", e);
            reback.setFail();
        }
        /*        //页面数据
    ...
    public ModelAndView toView() {
        ModelAndView mv = new ModelAndView("commission/commissionImport");
        return mv;
    }
    ...
    public ReturnView<?, ?> imput(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("pmlsSceneCommission", "PmlsSceneCommissionController", "imput", "", null, "", "", e1);
            rspMap.put(Constant.RETURN_CODE_KEY, ReturnCode.FAILURE);
    ...
    private ResultData insertLinkImport(List<Map<String, Object>> mapList) {
        ...
        try {
            ...
            for (Map<String, Object> map : mapList) {
                ...
                commissionDto.setUserCode(UserInfoHolder.get().getUserCode());

                commissionResultList.add(commissionDto);

            }

            resultData = pmlsSceneCommissionService.insertLnkImport(commissionResultList);
            return resultData;
        } catch (Exception e) {
    ...
    public void export(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            reback = pmlsSceneCommissionService.getLinkCommissionList(reqMap, null);
            ...
            logger.error("sceneLinkCommission",
                    ...
                    UserInfoHolder.getUserId(),//156 需还原成
