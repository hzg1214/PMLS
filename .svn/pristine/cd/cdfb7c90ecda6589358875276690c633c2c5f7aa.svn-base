...
<div class="cooperationPage">
    ...
    <input type="hidden" name="businessLicenseNo" id="businessLicenseNo" value="${cooperationInfo.businessLicenseNo}">
    <input type="hidden" name="companyNo" id="companyNo" value="${cooperationInfo.companyNo}">
    <input type="hidden" name="projectNo" id="projectNo" value="${cooperationInfo.projectNo}">

    <input type="hidden" name="htoapassDate" id="htoapassDate" value="${cooperationInfo.htoapassDate}">
    <input type="hidden" id="hsCode" name="hsCode" value="${cooperationInfo.hsCode}"/>
    <input type="hidden" id="hsName" name="hsName" value="${cooperationInfo.hsName}"/>
    <input type="hidden" id="khCode" name="khCode" value="${cooperationInfo.khCode}"/>
    <input type="hidden" id="khName" name="khName" value="${cooperationInfo.khName}"/>
    <input type="hidden" name="developersCode" id="developersCode" value="${cooperationInfo.developersCode}">
    <input type="hidden" name="developersName" id="developersName" value="${cooperationInfo.developersName}">
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-row blockBody">
                <div class="layui-col-xs6">
                    <div class="blockTitle">编辑联动分销合同</div>
                </div>
            ...
            <div class="layui-form cooperationForm">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="companyName" name="companyName" class="layui-input" placeholder="请选择" readonly="readonly"
                                   value="${cooperationInfo.companyName}" disabled/>
                        </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="projectName" name="projectName" class="layui-input" placeholder="请选择"
                                   ...
                                   value="${cooperationInfo.projectName}"/>
                        </div>
                        <div class="layui-input-inline" style="width: 64px;">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="projectAddr" name="projectAddr" value="${cooperationInfo.projectAddr}" class="layui-input" disabled/>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="htOaNo" name="htOaNo" class="layui-input" placeholder="请选择" readonly="readonly"
                                   value="${cooperationInfo.htOaNo}" disabled/>
                            <input type="hidden" id="contractType" name="contractType" value="${cooperationInfo.contractType}"/>
                        </div>
                        <div class="layui-input-inline" style="width: 64px;">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="wsqyzt" id="wsqyzt" class="layui-input" disabled value="${cooperationInfo.wsqyzt}">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="hidden" id="htDateStart" name="htDateStart" class="layui-input" value="${sdk:ymd2(cooperationInfo.htDateStart)}"/>
                            <input type="hidden" id="htDateEnd" name="htDateEnd" class="layui-input" value="${sdk:ymd2(cooperationInfo.htDateEnd)}"/>
                            <input type="text" id="htDate" name="htDate" class="layui-input" disabled
                                   value="${sdk:ymd2(cooperationInfo.htDateStart)}至${sdk:ymd2(cooperationInfo.htDateEnd)}"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="incomeSubject" class="layui-textarea" autocomplete="off" disabled
                                      style="width: 100%;">${cooperationInfo.incomeSubject}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="commissionMemo" class="layui-textarea" autocomplete="off" disabled
                                      style="width: 100%;">${cooperationInfo.commissionMemo}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="commissionMemoRemark" class="layui-textarea" autocomplete="off" disabled
                                      style="width: 100%;">${cooperationInfo.commissionMemoRemark}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="rtnCommission" class="layui-textarea" autocomplete="off" disabled
                                      style="width: 100%;">${cooperationInfo.rtnCommission}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="rtnCommissionMemo" class="layui-textarea" autocomplete="off" disabled
                                      style="width: 100%;">${cooperationInfo.rtnCommissionMemo}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="contractNameDesc" name="contractNameDesc" class="layui-input" maxlength="30" placeholder="请输入"
                                   value="${cooperationInfo.contractNameDesc}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item" style="display: none">
                    <div class="layui-inline">
                        <label class="layui-form-label"><span class="requiredClass">*</span>分销合同名称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="contractName" name="contractName" class="layui-input" maxlength="20" placeholder="请输入"
                                   value="${cooperationInfo.contractName}"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="cooperationRange" class="layui-textarea" autocomplete="off"
                                      style="width: 100%;" placeholder="不超过200字" maxlength="200">${cooperationInfo.cooperationRange}</textarea>
                        </div>
                    </div>
                </div>
...
<%--                                 <input type="radio" value="${list.dicCode}" id="${list.dicCode}" name="htedition" title="${list.dicValue}" disabled --%>
<%--                                        <c:if test="${list.dicCode eq cooperationInfo.htedition}">checked</c:if>> --%>
<%--                             </c:forEach> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div> -->
                        ...
                        <div class="layui-input-inline">
                            <c:forEach items="${signTypeList}" var="list">
                                <input type="radio" value="${list.dicCode}" id="${list.dicCode}" name="signType"  lay-filter="signType" title="${list.dicValue}"
                                       <c:if test="${list.dicCode eq cooperationInfo.signType}">checked</c:if>>
                            </c:forEach>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" id="htType1" name="htType" value="1671583364489561661" title="返佣" lay-filter="htType"
                                   <c:if test="${'1671583364489561661' eq cooperationInfo.htType}">checked</c:if>>
                            <input type="radio" id="htType2" name="htType" value="-1835969197405944893" title="垫佣" lay-filter="htType"
                                   <c:if test="${'-1835969197405944893' eq cooperationInfo.htType}">checked</c:if>>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" id="htCategory1" name="htCategory" value="3198954431064198420" title="模板合同" lay-filter="htCategory"
                                   <c:if test="${'3198954431064198420' eq cooperationInfo.htCategory}">checked</c:if>>
                            <input type="radio" id="htCategory2" name="htCategory" value="-7901965901473037886" title="非模板合同" lay-filter="htCategory"
                                   <c:if test="${'-7901965901473037886' eq cooperationInfo.htCategory}">checked</c:if>>
                            <input type="radio" id="htCategory3" name="htCategory" value="-938620031608930158" title="特殊合同" lay-filter="htCategory"
                                   <c:if test="${'-938620031608930158' eq cooperationInfo.htCategory}">checked</c:if>>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item" id="dyblDiv" style="display: none">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 193px;">
                            <input type="text" id="dybl" name="dybl" lay-verify="dybl" maxlength="5" value="${cooperationInfo.dybl}"
                ...
                <div class="layui-form-item" id="companyEleUserDiv" <c:if test="${cooperationInfo.signType=='29201'}">style="display:none" </c:if>  >
                    <div class="layui-inline">
                        <label class="layui-form-label"><span class="requiredClass">*</span>经纪公司电子授权人</label>
                        <div class="layui-input-inline">
                            <input type="text" id="companyEleUser" name="companyEleUser" maxlength="100" value="${cooperationInfo.companyEleUser}" class="layui-input"/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item" id="companyEleTelDiv" <c:if test="${cooperationInfo.signType=='29201'}">style="display:none" </c:if>>
                    <div class="layui-inline">
                        <label class="layui-form-label"><span class="requiredClass">*</span>经纪公司授权人电话</label>
                        <div class="layui-input-inline">
                            <input type="text" id="companyEleTel" name="companyEleTel" maxlength="11" value="${cooperationInfo.companyEleTel}" class="layui-input"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline dateLifeInput">
                            <input type="text" id="dateLifeStart" class="layui-input" placeholder="开始日期"
                                   value="${cooperationInfo.dateLifeStart}"/>
                        </div>
                        <div class="layui-form-mid">至</div>
                        <div class="layui-input-inline dateLifeInput">
                            <input type="text" id="dateLifeEnd" class="layui-input" placeholder="结束日期"
                                   value="${cooperationInfo.dateLifeEnd}"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="succeedSell" class="layui-textarea" autocomplete="off"
                                      style="width: 100%;" placeholder="不超过200字" maxlength="200">${cooperationInfo.succeedSell}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="fyjstj" class="layui-textarea" style="width: 100%;" placeholder="不超过200字" maxlength="200" disabled>${cooperationInfo.fyjstj}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="fyjsbz" class="layui-textarea" style="width: 100%;" placeholder="不超过200字" maxlength="200">${cooperationInfo.fyjsbz}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline settlePayNum">
                            <input type="text" id="settlePayNum" name="settlePayNum" maxlength="8" value="${cooperationInfo.settlePayNum}" class="layui-input" oninput="this.value=this.value.replace(/[^\d]/g,'')"  autocomplete="off" placeholder="请输入">
                        </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="violateAmount" name="violateAmount" lay-verify="violateAmount" maxlength="8" value="${cooperationInfo.violateAmount}"
                    ...
                    <%--<div class="layui-inline">--%>
                        ...
                        <%--<div class="layui-input-inline commissionInput">--%>
                            <%--<input type="text" id="commissionAmount" class="layui-input" placeholder="请输入"--%>
                                   <%--value="<fmt:formatNumber value="${cooperationInfo.commissionAmount}" pattern="#.##"></fmt:formatNumber>">--%>
                        <%--</div>--%>
                        ...
                        <%--<div class="layui-input-inline commissionInput">--%>
                            <%--<input type="text" id="commissionRatio" class="layui-input" placeholder="请输入"--%>
                                   <%--value="<fmt:formatNumber value="${cooperationInfo.commissionRatio}" pattern="#.##"></fmt:formatNumber>">--%>
                        <%--</div>--%>
                        <%--<div class="layui-form-mid">--%>
                            <%--%--%>
                        <%--</div>--%>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <textarea id="remark" class="layui-textarea" style="width: 100%;" placeholder="请输入">${cooperationInfo.remark}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <%--<c:forEach items="${cooperationInfo.fileList}" var="file">
                                        <c:if test="${file.fileTypeId eq '1067'}">
                                            <dd class="item_img" id="${file.fileRecordMainId}" data-id="${file.fileRecordMainId}">
                                                <div class="operate">
                                                    <i onclick="UPLOAD_IMG_DEL('${file.fileRecordMainId}')" class="close layui-icon"></i>
                                                </div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/cooperation/cooperationEdit.js?_v=${vs}"></script>
</body>
</html>
