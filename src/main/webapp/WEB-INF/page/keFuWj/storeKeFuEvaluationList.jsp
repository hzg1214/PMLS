...
<script type="text/javascript" src="${ctx}/meta/js/keFuWj/storeKeFuEvaluationList.js?_v=${vs}"></script>
</head>
<body>
	<!-- 头部 -->
			            ...
			            <tr>
				            ...
				            <c:forEach items="${contentlist}" var="list">
								<tr class="J_eatateItem" data-hidenumberflg="0">
                					...
                					<td  title="${list.cpTotalScore}" class="text-overflow">${list.cpTotalScore}</td>
                					<td>${list.userName}</td>
					                <td>${sdk:ymd2(list.dateCreate)}</td>
					                <td><a href="javascript:KeFuEvaluation.toEvaluationView(${list.id},${storeId},'${list.StoreNo}')">查看</a></td>
								</tr>	
							</c:forEach>
				    	</table>
				    	</form>
