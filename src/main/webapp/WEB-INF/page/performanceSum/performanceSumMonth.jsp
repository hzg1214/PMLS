...
<head>
    ...
    <script type="text/javascript" src="${ctx}/meta/js/performanceSum/performanceSumMonth.js?_v=${vs}"></script>
    ...
    <div class="row">
        ...
        <div class="page-content">
            <form id="PerformanceSumForm">
                ...
                <input type="hidden" name="dateStart" id="dateStart" value="2017-01-01">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group" id="date" style="width: 250px; margin-left: 0px;">
                            ...
                            <div class="form-group" id="day" style="width: 250px; margin-left: 0px;">
                                <label>起始天：</label>
                                <select class="multi-select-text" title="" id="startDay" name="startDay"
                                        notnull="true"
                                        style="width: 140px; margin-left: 0px;">
                                    <option value="-2">星期六</option>
                        ...
                        <div class="pull-right">
                            <button type="button" class="btn btn-primary" id="J_search"
                                    onclick="javascript:PerformanceSumMonth.search();">查询
                            </button>
                            <button type="button" class="btn btn-primary" id="btn-reset"
                                    onclick="javascript:PerformanceSumMonth.export()">导出
                            </button>
                        </div>
                    </div>
                </div>
