...
<head>
    ...
    <script type="text/javascript" src="${ctx}/meta/js/performanceSum/performanceSumWeek.js?_v=${vs}"></script>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <button type="button" class="btn btn-primary" id="J_search"
                                    onclick="javascript:PerformanceSumWeek.search();">查询
                            </button>
                            <button type="button" class="btn btn-primary" id="btn-reset"
                                    onclick="javascript:PerformanceSumWeek.export()">导出
                            </button>
                        </div>
                    </div>
                </div>
