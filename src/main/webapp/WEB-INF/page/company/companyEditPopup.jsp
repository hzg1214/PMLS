...
<script type="text/javascript" src="${ctx}/meta/js/company/companyEdit.js?_v=${vs}"></script>
                            ...
                            <label class="fw-normal w200 text-right"><i>*</i>修改后公司注册地址  ：</label>
                                   ...
                                   <span class="control-select">
                						<select class="form-control" title="" id="newCityNo" name="newCityNo" readonly>
                							<option value="${info.cityNo}"  selected="selected" readonly="true" >${info.cityName}</option>
                ...
                <ul class="list-inline half form-inline" style="display: none;" id="ulContactNumber">
                    <li>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control w300" id="contactNumber" name="contactNumber" placeholder="" notnull="true" autocomplete="off"  maxlength="11" dataType="phone">
