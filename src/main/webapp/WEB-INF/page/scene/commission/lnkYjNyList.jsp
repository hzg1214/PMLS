...
<script type="text/javascript" src="${ctx}/meta/js/scene/commission/lnkYjNyList.js?_v=${vs}"></script>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
	                       ...
	                       <div class="form-group" style="float:right;width:300px;">
							  ...
							  <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:LnkYjNy.search();" >查询</button>&nbsp;
							 <button type="button" id="btn-reset" class="btn btn-default"  onclick="javascript:LnkYjNy.reset()">重置</button>
							</div>
							 <div style="float:right" >
							 <button type="button" id="btn-output" class="btn btn-primary" onclick="javascript:LnkYjNy.output();">导出</button>&nbsp;
							 <button type="button" id="btn-imput" class="btn btn-primary" onclick="javascript:LnkYjNy.imput();">导入</button>
						     </div>
						</div>   
                        </div>
                    </div>
