...
<head>
    ...
    <script type="text/javascript" src="${ctx}/meta/js/scene/commission/lnkYjDyList.js?_v=${vs}"></script>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control " style="width:355px;" id="searchKey" name="searchKey" placeholder="请输入项目编号、开发商、楼室号、客户姓名、电话">
                            </div>
                        </div>
                        <div class="form-inline">
                            ...
                            <div class="form-group" style="margin-left: 9px;">
                                ...
                                <select class="form-control" title="" id="estateType" name="estateType" style="width:150px;">
                                    ...
                                    <option value="yj">应计垫佣模板</option>
                                    <option value="sj">实际垫佣模板</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-inline">
                            <div class="form-group" style="float:right">
                                <div style="float:left">
                                    <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:LnkYjDy.search();">查询
                                    </button>
                                    &nbsp;
                                    <button type="button" class="btn btn-default" id="btn-reset" onclick="javascript:LnkYjDy.reset();">重置
                                    </button>
                                    &nbsp;
                                    <button type="button" id="btn-output" class="btn btn-primary" onclick="javascript:LnkYjDy.output();">导出
                                    </button>
                                    &nbsp;
                                    <button type="button" id="btn-imput" class="btn btn-primary" onclick="javascript:LnkYjDy.imput();">导入
                                    </button>
                                </div>
                            </div>
                        </div>
