...
<%--     <%@ include file="/WEB-INF/page/common/jsCss.jsp"%> --%>
    ...
    <script type="text/javascript" src="${ctx}/meta/js/scene/commission/lnkYjReportList.js?_v=${vs}"></script>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control " style="width:355px;" id="searchKey" name="searchKey" placeholder="请输入项目编号、楼室号、客户姓名、电话">
                            </div>
                        </div>
                        <div class="form-inline">
...
<!--                                 <i>*</i> -->
                           ...
                           <div class="form-group">
                               ...
                               <input type="checkbox" value="1" id="checkbox1" name="objNum" ><label for="checkbox1" style="padding-left: 0px">已维护多个返佣对象</label>
                                   </div>
                           </div>
                        <div class="form-inline">
                            <div class="form-group" style="float:right">
                                <div style="float:left">
                                    <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:LnkYjReport.search();">查询
                                    </button>
                                    &nbsp;
                                    <button type="button" class="btn btn-default" id="btn-reset" onclick="javascript:LnkYjReport.reset('${list_search_page}');">重置
                                    </button>
                                    &nbsp;
                                    <button type="button" id="btn-output" class="btn btn-primary" onclick="javascript:LnkYjReport.achieveMentChange();">维护返佣对象
                                    </button>
                                </div>
                            </div>
                        </div>
...
<form name="imputForm" id="imputForm" method="post" action="${pageContext.request.contextPath}/lnkYjDy/imput" target="hiddenFrame" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	if (searchParamMap != undefined && searchParamMap != null && searchParamMap != '') {
		LnkYjReport.setSearchParams(searchParamMap);
	}
</script>
</html>