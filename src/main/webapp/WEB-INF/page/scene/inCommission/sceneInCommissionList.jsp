    ...
    <div class="row">
        ...
        <div class="page-content">
            <form id="SceneInCommissionListForm">
                ...
                <input type="hidden" name="estateType" id="estateType" value="20602">
                <input type="hidden" name="flagHref" id="flagHref" value="1">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="form-group" style="width:auto;">
                                    <span>业绩归属项目部：</span>
                                    <select class="form-control" style="width:150px;" id="projectDepartmentId"
                        ...
                        <div class="form-inline">
                            <div class="form-group" style="margin-left: 32px;">
                                ...
                                <select class="form-control" id="year" name="year" style="width:150px;">
                                    ...
                                    <option value="<% out.print(date.get(Calendar.YEAR)); %>"><% out.print(date.get(Calendar.YEAR)); %></option>
                                    <option value="<% out.print(date.get(Calendar.YEAR)-1); %>"><% out.print(date.get(Calendar.YEAR) - 1); %></option>
                                    <option value="<% out.print(date.get(Calendar.YEAR)-2); %>"><% out.print(date.get(Calendar.YEAR) - 2); %></option>
                                </select>
                                <input type="hidden" id="yearNow" value="<% out.print(date.get(Calendar.YEAR)); %>"/>
                            </div>
                            ...
                            <div class="form-group" style="float:right;">
                                <div style="float:left">
                                    <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:SceneInCommission.search();">查询</button>
                                    &nbsp;
                                    <button type="button" id="btn-reset" class="btn btn-default" onclick="javascript:SceneInCommission.reset()">重置</button>
                                    &nbsp;
                                    <button type="button" id="btn-output" class="btn btn-primary" onclick="javascript:SceneInCommission.output();">导出</button>
                                    &nbsp;
                                    <button type="button" id="btn-imput" class="btn btn-primary" onclick="javascript:SceneInCommission.imput();">导入</button>
                                </div>
                            </div>
                        </div>
                    </div>
