...
<script type="text/javascript" src="${ctx}/meta/js/scene/padCommission/scenePadCommission.js?_v=${vs}"></script>
	...
	<div class="container theme-hipage ng-scope" role="main">
        ...
        <div class="row">
            ...
            <div class="page-content">
                <form  id="ScenePadCommissionListForm">
					<input type="hidden" name="estateType" id="estateType" value="20604">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
	                       ...
	                       <div class="form-group" style="float:right;width:300px;">
							  ...
							  <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:ScenePadCommission.search();" >查询</button>&nbsp;
							 <button type="button" id="btn-reset" class="btn btn-default"  onclick="javascript:ScenePadCommission.reset()">重置</button>
							</div>
							 <div style="float:right" >
							 <button type="button" id="btn-output" class="btn btn-primary" onclick="javascript:ScenePadCommission.output();">导出</button>&nbsp;
							 <button type="button" id="btn-imput" class="btn btn-primary" onclick="javascript:ScenePadCommission.imput();">导入</button>
							 <%--<button type="button" id="btn-del" class="btn btn-primary" onclick="javascript:ScenePadCommission.del();">删除</button>--%>
						     </div>
						</div>   
                        </div>
                    </div>
