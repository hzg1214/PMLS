...
<table class="table table-striped table-hover table-bordered" style="width:1950px;font-size: 12px;">
    <tbody class="s-w100">
    <tr>
    ...
    <tr>
        ...
        <th>不动产受理</th>
        <th>办结</th>
        <th style="vertical-align: middle;width:70px;">报备</th>
        <th style="vertical-align: middle;width:70px;">带看</th>
        <th style="vertical-align: middle;width:70px;">大定套数</th>
        <th>大定金额</th>
        <th>成销套数</th>
        <th>成销金额</th>
    </tr>
