...
<script type="text/javascript" src="${ctx}/meta/js/houseLinkage/statistic/statisticDetail.js?_v=${vs}"></script>
            ...
            <div class="page-content">
                ...
                <caption>
			        <div class="float-right" >
			          <a href="${ctx}/statistic/qCompanyInit/${estateId}/${prevCountDateStart}/${prevCountDateEnd}/${prevCountDateTypeKbn}?searchParam=1""  class="btn btn-primary" style="margin-bottom:10px">返回</a>
			        </div>
			    </caption>
                    <!-- 异步加载列表内容 -->
	                <div id="load_content">
