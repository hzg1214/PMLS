...
<h4 class="border-bottom pdb10" style="margin-right: -15px;margin-left:-15px;"><strong>公盘合同</strong></h4>
    <div class="row">
        ...
        <div class="page-content">
            <form id="gpCsMemberContractForm">
                ...
                <div class="panel panel-default" style="margin-bottom:10px;">
                    <div class="panel-body">
                        <div class="form-inline">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="margin-left: 12px;">申请编号</label>
                                    <input type="text" class="form-control" id="searchKey" name="searchKey" style="width:287px;" placeholder="初始会员申请编号/初始会员协议书编号" value="">
                                </div>
                                <div class="form-group">
                                    <label>创建时间</label>
                        ...
                        <div class="form-inline">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label style="margin-left: 25px;">创建人</label>
                            ...
                            <div class="col-md-4">
                                <button type="button" class="btn btn-primary" id="J_search" onclick="javascript:GpCsMemberContract.search();" style="margin-left:60px;">
                                    搜索
                                </button>
                                &nbsp;
                                <a type="button" class="btn btn-default" onclick="javascript:GpCsMemberContract.reset('${list_search_page}');">重置</a>
                                &nbsp;
                                <a type="button" class="btn btn-primary" href="javascript:GpCsMemberContract.create();"  style="float:right">新增初始会员合同</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    if (searchParamMap != undefined && searchParamMap != null && searchParamMap != '') {
    	GpCsMemberContract.setSearchParams(searchParamMap);
    }
</script>
</html>
