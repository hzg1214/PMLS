    ...
    <div class="layui-card-body">
        ...
        <div class="layui-form myForm" style="margin-top:20px;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <input type="radio" value="0" name="isWrap" lay-filter="isWrap"
                           lay-verify="required|isWrap" title="否" checked="checked">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><i>*</i>楼室号</label>
                <input type="hidden" id="newChange_buildingNoId" name="newChange_buildingNoId" value=""/>
                <input type="hidden" id="newChange_buildingNo" name="newChange_buildingNo" value=""/>
                <input type="hidden" id="newChange_roughArea" name="newChange_roughArea" value=""/>

                <div class="layui-inline w250">
                    <input type="text" id="buildingNo" name="buildingNo" lay-verify="buildingNo"
                           data-buildingNoId="" lay-filter="buildingNo" value="" maxlength="30" autocomplete="off"
                           value="" class="layui-input" placeholder="请输入">
                </div>
                <div id="divbuildingNo" class="layui-inline" style="width: 100px!important; display: none;">
                ...
                <div class="layui-inline w250">
                    <select id="ddlWYType" name="ddlWYType" lay-verify="ddlWYType" lay-filter="ddlWYType">
                        ...
                        <c:forEach items="${wyTypeList}" var="wyType">
                            <option value="${wyType.wyTypeCode}">${wyType.wyTypName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline w250">
                    <input type="text" id="roughArea" name="roughArea" lay-verify="roughArea"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline w250">
                    <input type="text" id="roughAmount" name="roughAmount" lay-verify="roughAmount"
                           lay-filter="roughAmount" maxlength="20" autocomplete="off" value=""
                           oninput="this.value=this.value.replace(/[^\-?\d.]/g,'')"
                           class="layui-input" placeholder="请输入">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-inline w250">
                    <input type="text" id="roughInputDate" name="roughInputDate" lay-verify="roughInputDate"
                           lay-filter="roughInputDate"
                           value="" autocomplete="off" class="layui-input" placeholder="请选择">
                </div>
            </div>
        </div>
    </div>
...
<script src="${ctx}/meta/pmls/js/scene/sceneTrade/roughtAdd.js?v=${vs}"></script>
</body>
</html>