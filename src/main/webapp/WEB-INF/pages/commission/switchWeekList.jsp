                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yearMonth" id="yearMonth" lay-verify="yearMonth"
                                   placeholder="请选择年月" lay-verify="required" class="layui-input" autocomplete="off" >
                        ...
                        <div class="layui-input-inline">
                            <select id="weekNo" name="weekNo" lay-verify="required" lay-filter="weekNo" autocomplete="off" >
                                <option value="" selected>请选择月周</option>
...
<div>
    <div class="layui-card">
        ...
        <div class="layui-card-header">
            <div class="layui-inline toolbar">
                <shiro:hasPermission name="/pmlsPerformSwitchWeek:E_CLOSE">
                    <button class="layui-btn" id="btnImport" data-type="closeSwitch">关账</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="/pmlsPerformSwitchWeek:E_OPEN">
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/commission/switchWeekList.js?v=${vs}"></script>
