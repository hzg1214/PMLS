                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline w250">
                            <input type="text" id="keyword" name="keyword"  maxlength="200" class="layui-input" autocomplete="off" placeholder="客户姓名、楼室号、订单编号">
                        </div>
                    </div>
    ...
    layui.use(['element', 'form', 'table', 'layer'], function () {
        ...
        function setCols() {
            ...
            row.push(
                ...
                {field: 'reportId', fixed: 'left', title: '订单编号', width: 150, align: 'center'},
                ...
                {field: 'vaildDYAmount', title: '可垫金额（元）', width: 125, align: 'center',style:'text-align:right'
                    , templet: function (d) {
                ...
                {field: 'vaildFYAmount', title: '可返金额（元）', width: 125, align: 'center',style:'text-align:right'
                    , templet: function (d) {
        ...
        function reloadData() {
            ...
            table.reload('mainTable', {
                url: BASE_PATH + '/jsStatement/queryJsNormalReportList',
                cols: setCols(),
