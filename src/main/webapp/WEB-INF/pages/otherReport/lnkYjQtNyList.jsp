...
<%--                            <input type="hidden" id="estateNmKey" name="estateNmKey" />--%>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="projectNo" id="projectNo" placeholder="请输入"  lay-verify="projectNo"  autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="reportNo" id="reportNo" placeholder="请输入"  lay-verify="reportNo"  autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline w90">
                            <input type="text" name="countDateStart" id="countDateStart" lay-verify="countDateStart"
                                   lay-filter="countDateStart"  autocomplete="off" class="layui-input" placeholder="开始日期">
                        </div>
                        <div class="layui-input-inline w90">
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/otherReport/lnkYjQtNyList.js?_v=${vs}"></script>
