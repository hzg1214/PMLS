    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <form class="layui-form searchForm">
                <input type="hidden" id="projectNo" value="${reqMap.projectNo}"/>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">渠道公司</label>
                        <div class="layui-input-inline">
                            <input type="text" id="companyKey"  autocomplete="off" name="companyKey" class="layui-input" placeholder="渠道公司编号、名称">
                        </div>
                    </div>
...
<script type="text/javascript" src="${ctx}/meta/pmls/js/yjPlan/selCompany.js?v=${vs}"></script>
