            ...
            <div style="margin: 0 auto;">
                <div class="layui-row blockBody">
                    <div class="layui-col-xs6">
                        <div class="blockTitle">借佣框架协议详情</div>
                    </div>
                    ...
                    <div class="layui-col-xs6 blockBtn">
                        <shiro:hasPermission name="/borrowFrameContract:submitOA">
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs2 lable-left">OA状态：</div>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs2 lable-left">OA审核状态：</div>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs2 lable-left">OA审核通过时间：</div>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs2 lable-left">乙方代表联系人：</div>
                    <div class="layui-col-xs4 lable-right">${frameContractDto.partyBNm}</div>
                </div>
                <div class="layui-row">
                    <div class="layui-col-xs2 lable-left">开户行：</div>
                    <div class="layui-col-xs4 lable-right">${frameContractDto.bankAccountNm}</div>
                    <div class="layui-col-xs2 lable-left">乙方代表联系方式：</div>
                    <div class="layui-col-xs4 lable-right">${frameContractDto.partyBTel}</div>
                </div>
                <div class="layui-row">
...
<script src="${pageContext.request.contextPath}/meta/pmls/js/borrowMoneyFrameContract/borrowMoneyFrameContractDetailPage.js?v=${vs}"></script>
