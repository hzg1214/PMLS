...
layui.use(['element', 'laydate', 'form', 'table', 'layer'], function () {
    ...
    function setCols() {
        ...
        row1.push(
            {field: '',title: '房友返佣小计',width:150, align: 'center',colspan: 2},
            {field: '',title: '房友返佣',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整1',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整2',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整3',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整4',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整5',width:150, align: 'center',colspan: 3},
            {field: '',title: '房友返佣调整6',width:150, align: 'center',colspan: 3}
        );
    ...
    active = {
        ...
        export: function () {
            if (valid()) {
                ...
                var url = BASE_PATH + '/pmlsLnkYjFyFy/exportCheck?cityNo=' + $("#cityNo").val() + "&projectDepartmentId=" + $("#projectDepartmentId").val()
                    + "&searchKey=" + encodeURIComponent($("#searchKey").val()) + "&reportId=" + $("#reportId").val() + "&countDateStart=" +$("#countDateStart").val()
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.returnCode == 200 || data.returnCode == '200') {
                            window.location.href = BASE_PATH + '/pmlsLnkYjFyFy/export?cityNo=' + $("#cityNo").val() + "&projectDepartmentId=" + $("#projectDepartmentId").val()
                                + "&searchKey=" + encodeURIComponent($("#searchKey").val()) + "&reportId=" + $("#reportId").val() + "&countDateStart=" +$("#countDateStart").val()
                                + "&countDateEnd=" + $("#countDateEnd").val() + "&estateType=" + $("#estateType").val()
                                + "&estateNmKey=" + getXMSelectIds(formSelects.value('estateNmKey'))+"&businessType=" + $("#businessType").val();
        ...
        import: function () {
            layer.open({
                ...
                title: 'EXCEL导入',
                area: ['500px', '400px'],
                content: BASE_PATH + '/pmlsLnkYjFyFy/toView'
            });
    ...
    function reloadData(optionsData) {
        ...
        table.reload('contentReload', {
            url: BASE_PATH + '/pmlsLnkYjFyFy/queryList',
            cols: setCols(),
            where: optionsData,
            page:{
                curr: 1 //重新从第 1 页开始
