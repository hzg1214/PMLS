...
layui.use(['element', 'laydate', 'form', 'table', 'layer'], function () {
    ...
    function setCols() {
        ...
        row1.push(
            {type: 'radio'},
            {field: 'companyNo', title: '渠道公司编号', width: 218, align: 'center'},
            {field: 'companyName', title: '渠道公司名称', width: 500, align: 'center',
            	templet: function (d) {
...
//            ,
//            {
//            	field: 'dateLifeStart', title: '合作周期', width: 300, align: 'center',
//                templet: function (d) {
...
//            }
    ...
    function reloadData() {
        ...
        var companyKey = trimStr($("#companyKey").val());
        optionsData.companyKey = companyKey;
        ...
        table.reload('mainTable', {
            url: BASE_PATH + '/pmlsEstatePlan/getCompanyList',
            cols: setCols(),
