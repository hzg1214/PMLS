...
initList = function () {
    ...
    httpGetWithParams('PerformanceSumForm', 'LoadCxt', params, BASE_PATH + '/performanceSum/queryYear', function () {
 ...
 *
 */
PerformanceSumYear.search = function () {
...
PerformanceSumYear.export = function () {
    ...
    window.location.href = LOC_RES_BASE_PATH + "/performanceSum/exportYear?"
        + "type=" + type
