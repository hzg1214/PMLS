...
public class ExcelForLinkDetail extends ExcelUseXmlAbstract {
    ...
    public void downloadSheet(List<LinkedHashMap<String, Object>> list, File file, String yearly) throws IOException {
    ...
    private int createSheetHead(SpeedSheetWriter sw, int index, List<String> listMerge) throws IOException {
        ...
        nowColIndex = createBlock(sw, "业绩信息", 11, 1, listMerge);
        nowColIndex = createBlock(sw, "案件信息", 33, 1, listMerge);
        ...
        nowColIndex = createBlock(sw, "经纪公司名称", 7, 1, listMerge);
        ...
        nowColIndex = createBlock(sw, "成销", 4, 1, listMerge);
    ...
    public List<ExcelColumnSet> setColumnWidth() {
        ...
        //城市
        c = new ExcelColumnSet(String.valueOf(nColIndex), String.valueOf(nColIndex + 9));
        c.setWidth(12);
        columnSet.add(c);
        nColIndex += 11;
