...
import cn.com.eju.deal.poi.ExcelForLnkYjDy;
...
public class LnkYjDyController extends BaseController {
    ...
    public String list(HttpServletRequest request, ModelMap mop) {
        ...
        try {
            ...
            logger.error("lnkYjDy", "LnkYjDyController", "", "", null, "", "创建--初始化-归属项目部", e);
        }
        try {
            ...
            logger.error("lnkYjDy", "LnkYjDyController", "", "", null, "", "创建--初始化-楼盘名称", e);
        }
        return "scene/commission/lnkYjDyList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "getLnkYjDyList", method = RequestMethod.GET)
    public String getLnkYjDyList(HttpServletRequest request, ModelMap mop) {
        String cityNo = UserInfoHolder.get().getCityNo();
        //获取请求参数
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = lnkYjDyService.getLnkYjDyList(reqMap, pageInfo);
        } catch (Exception e) {
            logger.error("lnkYjDy", "LnkYjDyController", "getLnkYjDyList", "", null, "", "", e);
            reback.setFail();
        }
        ...
        return "scene/commission/lnkYjDyListCtx";
    ...
    public ReturnView<?, ?> exportCheck(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            reqMap.put("cityNo", cityNo);
            reback = lnkYjDyService.getLnkYjDyList(reqMap, null);
    ...
    public void export(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ResultData<?> reback = lnkYjDyService.getLnkYjDyList(reqMap, null);
            List<LinkedHashMap<String, Object>> contentlist = (List<LinkedHashMap<String, Object>>) reback.getReturnData();
    ...
    public ReturnView<?, ?> imput(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            //数据导入
            ResultData insertResult = lnkYjDyService.dyImport(mapList);
            ...
            logger.error("lnkYjDy", "LnkYjDyController", "imput", "", null, "", "", e1);
            rspMap.put(Constant.RETURN_CODE_KEY, ReturnCode.FAILURE);
